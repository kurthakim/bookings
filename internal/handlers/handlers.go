...
import (
	...
	"github.com/kurthakim/bookings/internal/driver"
	"github.com/kurthakim/bookings/internal/forms"
	"github.com/kurthakim/bookings/internal/helpers"
	"github.com/kurthakim/bookings/internal/models"
	"github.com/kurthakim/bookings/internal/render"
	"github.com/kurthakim/bookings/internal/repository"
	"github.com/kurthakim/bookings/internal/repository/dbrepo"
)
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		m.App.Session.Put(r.Context(), "error", "type assertion failed")
		http.Redirect(w, r, "/", http.StatusTemporaryRedirect )
		return
	}
